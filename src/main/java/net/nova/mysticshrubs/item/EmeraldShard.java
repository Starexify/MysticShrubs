...
public class EmeraldShard extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        ItemStack emeraldShard = new ItemStack(MSItems.EMERALD_SHARD.get());
        ...
        if (emeraldShardCount >= 8) {
            ...
            ItemStack giveEmeraldPiece = new ItemStack(MSItems.EMERALD_PIECE.get());
            pPlayer.addItem(giveEmeraldPiece);

            // Play sound
            if (!pLevel.isClientSide()) {
                pLevel.playSound(null, pPlayer.getX(), pPlayer.getY(), pPlayer.getZ(), Sounds.EMERALD_SHARD_USED.get(), SoundSource.PLAYERS, 1.0f, 1.0f);
            } else {
                pLevel.playLocalSound(pPlayer.getX(), pPlayer.getY(), pPlayer.getZ(), Sounds.EMERALD_SHARD_USED.get(), SoundSource.PLAYERS, 1.0f, 1.0f, false);
            }
