...
public class EmeraldPiece extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        ItemStack emeraldPiece = new ItemStack(ModItems.EMERALD_PIECE.get());
        ...
        if (emeraldPieceCount >= 8) {
            ...
            if (!pLevel.isClientSide()) {
                pLevel.playSound(null, pPlayer.getX(), pPlayer.getY(), pPlayer.getZ(), ModSounds.EMERALD_PIECE_USED.get(), SoundSource.PLAYERS, 1.0f, 1.0f);
            } else {
                pLevel.playLocalSound(pPlayer.getX(), pPlayer.getY(), pPlayer.getZ(), ModSounds.EMERALD_PIECE_USED.get(), SoundSource.PLAYERS, 1.0f, 1.0f, false);
            }
